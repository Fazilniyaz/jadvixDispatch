...
export function Logo({ className, showProduct = true, markOnly = false }: LogoProps) {
  return (
    <div className={cn('flex items-center gap-2.5', className)}>
      <span className="grid h-7 w-7 shrink-0 place-items-center bg-accent text-white font-bold text-sm rounded-[3px] leading-none">
        J
      </span>
      {!markOnly && (
